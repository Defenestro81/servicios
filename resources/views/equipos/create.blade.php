            ...
            <div class="bg-white shadow-sm sm:rounded-lg p-6">
                <form method="POST" action="{{ route('equipos.store') }}">
                    ...
                    <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                        <div class="sm:col-span-2">
                            ...
                            <div class="mt-1">
                                <x-tipo-equipo-select :tipos="$tipos" name="tipo_equipo_id"
                                    :selected="old('tipo_equipo_id', '')" :required="true" />
                            </div>
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <x-text-input id="etiqueta" name="etiqueta" type="text" class="mt-1 block w-full font-mono"
                                value="{{ old('etiqueta') }}" placeholder="Ej: EQ-00001" required autofocus />
                    ...
                    <div class="mt-6 flex gap-3">
                        ...
                        <a href="{{ route('equipos.index') }}" class="px-4 py-2 text-sm text-gray-600 hover:text-gray-800">Cancelar</a>
                    </div>
                </form>
            </div>
        </div>
